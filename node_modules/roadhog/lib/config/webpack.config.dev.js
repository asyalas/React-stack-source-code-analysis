...
exports.default = function (config, cwd) {
  ...
  var finalWebpackConfig = _extends({
    ...
    module: {
      rules: [].concat(_toConsumableArray((0, _common.getFirstRules)({ paths: paths, babelOptions: babelOptions })), _toConsumableArray((0, _common.getCSSRules)('development', { config: config, paths: paths, cssLoaders: cssLoaders, theme: theme })), _toConsumableArray((0, _common.getLastRules)({ paths: paths, babelOptions: babelOptions })))
    },
    plugins: [new _webpack2.default.HotModuleReplacementPlugin(), new _caseSensitivePathsWebpackPlugin2.default(), new _WatchMissingNodeModulesPlugin2.default(paths.appNodeModules), new _systemBellWebpackPlugin2.default()].concat(dllPlugins, _toConsumableArray((0, _common.getCommonPlugins)({
      config: config,
      paths: paths,
