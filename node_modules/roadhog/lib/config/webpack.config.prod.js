...
exports.default = function (args, appBuild, config, paths) {
  ...
  var finalWebpackConfig = _extends({
    ...
    module: {
      rules: [].concat(_toConsumableArray((0, _common.getFirstRules)({ paths: paths, babelOptions: babelOptions })), _toConsumableArray((0, _common.getCSSRules)('production', { config: config, paths: paths, cssLoaders: cssLoaders, theme: theme })), _toConsumableArray((0, _common.getLastRules)({ paths: paths, babelOptions: babelOptions })))
    },
